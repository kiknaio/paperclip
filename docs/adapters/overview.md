...
summary: What adapters are and how they connect agents to Yawnless.ai
---

Adapters are the bridge between Yawnless.ai's orchestration layer and agent runtimes. Each adapter knows how to invoke a specific type of AI agent and capture its results.

## How Adapters Work

When a heartbeat fires, Yawnless.ai:
...
packages/adapters/<name>/
  src/
    ...
    cli/
      format-event.ts   # Terminal output for `yawnlessai run --watch`
```
