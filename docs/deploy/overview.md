...
Yawnless.ai supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying Yawnless.ai?** Use `local_trusted` (the default)
