...
- `YAWNLESS_APPROVAL_ID` — the resolved approval
- `YAWNLESS_APPROVAL_STATUS` — `approved` or `rejected`
- `YAWNLESS_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
