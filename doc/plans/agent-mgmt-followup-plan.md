...
- `skills/yawnless/SKILL.md` and `skills/yawnless/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.2 `skills/yawnless-create-agent/SKILL.md`
