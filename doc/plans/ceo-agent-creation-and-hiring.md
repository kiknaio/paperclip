...
- installed adapter list for this Yawnless.ai instance
...
## 8. New Skill: `yawnless-create-agent`

Create new skill directory:

- `skills/yawnless-create-agent/SKILL.md`
...
Also update `skills/yawnless/SKILL.md` to reference this skill for hiring workflows.
...
- `yawnless-create-agent` skill + docs updates
