...
import { models as codexFallbackModels } from "@yawnlessai/adapter-codex-local";
import { models as cursorFallbackModels } from "@yawnlessai/adapter-cursor-local";
import { resetOpenCodeModelsCacheForTests } from "@yawnlessai/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.YAWNLESS_OPENCODE_COMMAND;
  ...
  it("returns no opencode models when opencode command is unavailable", async () => {
    process.env.YAWNLESS_OPENCODE_COMMAND = "__paperclip_missing_opencode_command__";
