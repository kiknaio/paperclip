...
name: design-guide
description: >
  Yawnless.ai UI design system guide for building consistent, reusable frontend
...
# Yawnless.ai Design Guide

Yawnless.ai's UI is a professional-grade control plane — dense, keyboard-driven, dark-themed by default. Every pixel earns its place.
...
2. **Custom composites** (`ui/src/components/`) — StatusBadge, EntityRow, MetricCard, etc. These capture Yawnless.ai-specific design language.
