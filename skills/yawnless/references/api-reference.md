# Yawnless.ai API Reference

Detailed reference for the Yawnless.ai control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "Yawnless.ai Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "yawnless-mobile",
    "cwd": "/Users/me/yawnless-mobile",
    "repoUrl": "https://github.com/acme/yawnless-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `yawnless-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
