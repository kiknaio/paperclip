...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@yawnlessai/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@yawnlessai/adapter-utils").TranscriptEntry[];
