...
import { buildProjectMentionHref, parseProjectMentionHref } from "@yawnlessai/shared";
...
export const MarkdownEditor = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function MarkdownEditor({
    ...
    for (const node of links) {
      ...
      if (!parsed) {
        if (link.dataset.projectMention === "true") {
          ...
          link.classList.remove("yawnless-project-mention-chip");
      ...
      link.classList.add("yawnless-project-mention-chip");
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative yawnless-mdxeditor-scope",
    ...
    >
      <MDXEditor
        ...
        onBlur={() => onBlur?.()}
        className={cn("yawnless-mdxeditor", !bordered && "yawnless-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "yawnless-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
