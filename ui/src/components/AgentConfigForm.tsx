...
import { AGENT_ADAPTER_TYPES } from "@yawnlessai/shared";
import type {
  Agent,
...
// Canonical type lives in @yawnlessai/adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "@yawnlessai/adapter-utils";
import type { CreateConfigValues } from "@yawnlessai/adapter-utils";
  ...
  return (
    <div className="space-y-1.5">
      ...
      <p className="text-[11px] text-muted-foreground/60">
        YAWNLESS_* variables are injected automatically at runtime.
      </p>
    </div>
  );
}
